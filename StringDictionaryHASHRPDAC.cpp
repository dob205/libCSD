...
uchar *StringDictionaryHASHRPDAC::extract(size_t id, uint *strLen) {
  if ((id > 0) && (id <= elements)) {
    uint *rules;
...
void StringDictionaryHASHRPDAC::save(std::ostream &out) {
...
StringDictionary *StringDictionaryHASHRPDAC::load(std::istream &in,
                                                  uint technique) {
