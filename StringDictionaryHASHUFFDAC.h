 ...
 *   ==========================================================================
 *
 * The well-known Huffman code (in its canonical form) is used for compressiong
 * the strings, and the resulting byte stream is loaded into a Directly
 * Adressable Codes (DAC) structure.
 *
 *   ==========================================================================
