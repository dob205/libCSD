...
size_t LCP_PhiSpare::get_seq_LCP(size_t i, TextIndex *csa, size_t **, size_t *,
                                 bool) const {
...
void LCP_PhiSpare::save(std::ostream &fp) const {
...
LCP_PhiSpare *LCP_PhiSpare::load(std::istream &fp) {
