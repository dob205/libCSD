...
// const int coversizes[max_precomputed_cover + 1] = {1, 2, 3, 4, 5, 7, 9, 13,
// 20}; (unused)
...
const unsigned cover8[] = {0,  1,  3,   7,   12,  20,  30,  44,  65,  80,
                           89, 96, 114, 122, 128, 150, 196, 197, 201, 219};
...
size_t LCP_PT::get_seq_LCP(size_t i, TextIndex *csa, size_t **, size_t *,
                           bool) const {
