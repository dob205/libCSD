...
SuffixTreeY::SuffixTreeY(char *text, size_t n, size_t lcp_type, size_t npr_type,
  ...
  case NAIVE:
    ...
    break;
  case SAD_GON_OS:
    lcp = new LCP_Sad(csa, text, length);
    break;
  case FMN_RRR_OS:
    lcp = new LCP_FMN(csa, text, length);
    break;
  case PT:
    lcp = new LCP_PT(csa, text, length);
    break;
  case PHI:
    lcp = new LCP_PhiSpare(csa, text, length);
    break;
  case DAC:
    lcp = new LCP_DAC(csa, text, length);
    break;
  case DAC_VAR:
    lcp = new LCP_DAC_VAR(csa, text, length);
    break;
  default:
    exit(0);
  }
...
size_t SuffixTreeY::Count(size_t vl, size_t vr) const { return vr - vl + 1; }
...
void SuffixTreeY::Parent(size_t vl, size_t vr, size_t *parent_l,
...
void SuffixTreeY::FChild(size_t vl, size_t vr, size_t *fchild_l,
...
void SuffixTreeY::NSibling(size_t vl, size_t vr, size_t *nsibling_l,
...
void SuffixTreeY::SLink(size_t vl, size_t vr, size_t *slink_l,
...
void SuffixTreeY::SLink_i(size_t vl, size_t vr, size_t i, size_t *slinki_l,
...
void SuffixTreeY::LCA(size_t vl, size_t vr, size_t wl, size_t wr, size_t *lca_l,
                      size_t *lca_r) const {
  size_t k;
...
void SuffixTreeY::Child(size_t vl, size_t vr, char a, size_t *child_l,
...
char SuffixTreeY::Letter(size_t vl, size_t, int i) const {
  char l;
  if (i == 1) {
    l = (char)csa->getT(vl);
    return l;
...
void SuffixTreeY::LAQs(size_t vl, size_t vr, size_t d, size_t *laq_s_l,
...
void SuffixTreeY::LAQt(size_t vl, size_t vr, size_t d, size_t *laq_t_l,
