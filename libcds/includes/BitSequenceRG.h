...
public:
   ...
   * The <code>factor</code> value has to be either 2,3,4 or 20, being the first
   * one the fastest/bigger.
   */
  ...
  /*load-save functions*/
  virtual void save(std::ostream &f) const;
  static BitSequenceRG *load(std::istream &f);
};
